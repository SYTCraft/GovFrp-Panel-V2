	...
	Swal.fire({
		...
		.then((result) => {
			if (result.isConfirmed) {
				window.open("?page=panel&module=account");
			}
		})
}
</script>
		...
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0 text-dark">
					<?php echo $page_title; ?>&nbsp;&nbsp;<small class="text-muted text-xs">签到以获取免费的流量</small>
				</h1>
			</div>
			<div class="col-sm-6">
...
<div class="content" style="position: relative;" oncopy="return false" oncut="return false;" onselectstart="return false" oncontextmenu="return false">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-7" style="display:block;margin:0 auto;">
                ...
                <div class="card">
                    ...
                    <div class="card-body fix-text">
						...
						<p>运行状态：<?php echo $_config['sign']['enable'] ? "<span class='text-success'>正常</span>" : "<span class='text-danger'>不可用</span>"; ?></p>
