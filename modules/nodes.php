                    ...
                    <div class="card-body p-0 table-responsive">
						<table class="table table-bordered table-hover dataTable dtr-inline" style="width: 100%;font-size: 15px;">
							<tr>
								...
								<th class='text-center' nowrap>主机名称</th>
								<th class='text-center' nowrap>IPv4 地址</th>
								<th class='text-center' nowrap>节点端口</th>
							...
							foreach($rs as $node) {
								...
								<td class='text-center' nowrap><a href='javascript:deletenode({$node[0]})'>[删除]</a> | <a href='javascript:edit({$node[0]})'>[编辑]</a></td>
								";
							}
							?>
						</table>
			...
			<div class="col-lg-4">
				<div class="card">
					<div class="card-body">
						...
						<p><b>IPv4 地址</b>&nbsp;&nbsp;<small>服务器的 IP 地址，请不要输入域名</small></p>
